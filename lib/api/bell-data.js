...
class BellData {
	...
	async createNewHit(a) {
		...
		await this.query(
			'INSERT INTO hits (device_id, time, pathname, ip, referrer, school, period, prefs, theme, speed, tti, ttfb, version) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
			[a.device_id, a.time, a.pathname, a.ip, a.referrer, a.school, a.period, a.prefs, a.theme, a.speed, a.tti, a.ttfb, a.version]
		);
