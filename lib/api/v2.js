...
module.exports = async (path, postData) => {
	...
	switch (path) {
		...
		case '/write/analytics':
			...
			if (!device_id || !pathname || !prefs || typeof referrer !== 'string' || !speed)
				return responses.missing_data;
			...
			let values = {
				...
				pathname,
				referrer,
				version: version || null, // remove when everybody has updated
			...
			if (typeof school !== 'string' || school.length > 30)
				return responses.bad_data;
