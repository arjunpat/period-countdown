...
class BellData {
	...
	async createNewHit(a) {
		...
		await this.query(
			'INSERT INTO hits (device_id, time, pathname, referrer, new_load, period, prefs, theme, speed, tti, ttfb, version) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
			[a.device_id, a.time, a.pathname, a.referrer, a.new_load, a.period, a.prefs, a.theme, a.speed, a.tti, a.ttfb, a.version]
		);
