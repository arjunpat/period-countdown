...
class BellData {
	...
	async createNewHit(a) {
		...
		await this.query(
			'INSERT INTO hits (device_id, time, pathname, referrer, period, prefs, theme, speed, tti, ttfb, version) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
			[a.device_id, a.time, a.pathname, a.referrer, a.period, a.prefs, a.theme, a.speed, a.tti, a.ttfb, a.version]
		);
